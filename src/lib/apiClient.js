...
// 휴대폰 인증번호 요청
export const requestPhoneVerify = payload => api.post('/api/auth/phone/request', payload);

// 휴대폰 인증번호 확인
export const confirmPhoneVerify = payload => api.post('/api/auth/phone/verify', payload);
